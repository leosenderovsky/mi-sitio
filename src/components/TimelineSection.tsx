    ...
    <div className={`${textColor} ${bgColor} p-4 shadow-lg`}>
      <div className="max-w-5xl mx-auto">
                  ...
                  >
                    ...
                    {edu.diplomaUrl && (
                      <button
                        ...
                        className={`inline-flex items-center gap-2 font-heading text-sm uppercase transition-all px-3 py-1.5 rounded mt-4 ${
                          isDark
                            ? "text-[#1B1440] border border-[#1B1440] hover:bg-[#1B1440] hover:text-white"
                            : "text-[#0D0B2E] border border-[#0D0B2E] hover:bg-[#0D0B2E] hover:text-white"
                        }`}
                      >
                        <svg
                          viewBox="0 0 64 64"
                          ...
                          aria-hidden="true"
                          className="h-4 w-4 self-center shrink-0 fill-current"
                        >
        ...
        c0,1.6543007-1.3457985,3-3,3c-1.6543007,0-3-1.3456993-3-3C35.5708504,41.0383224,36.9165497,39.692524,38.5708504,39.692524z"/>
                        ...
                        <span className="leading-none self-center">Ver certificado</span>
                      </button>
                    )}
                  </div>
                </div>
