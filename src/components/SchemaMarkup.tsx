...
export function SchemaGlobal() {
  const person = {
    ...
    "description": "Editor de video senior, guionista, consultor de guión, docente de cine, desarrollador web Frontend y especialista en IA aplicada al audiovisual. Basado en Buenos Aires, Argentina.",
    "jobTitle": [
      "Editor de Video",
      "Guionista",
      "Consultor de Guión",
  ...
  const website = {
    ...
    "description": "Sitio personal y portfolio de Leo Aquiba Senderovsky: editor de video, guionista, docente de cine, desarrollador web y especialista en IA.",
    "inLanguage": "es-AR",
    "publisher": {
      "@id": "https://leosenderovsky.com.ar/#person"
    },
    "potentialAction": {
      ...
      "target": {
        "@type": "EntryPoint",
        "urlTemplate": "https://leosenderovsky.com.ar/?s={search_term_string}"
      },
  ...
  const services = [
    {
      ...
      "description": "Edición audiovisual profesional para documentales, spots publicitarios, contenido para redes sociales y medios de comunicación. Más de 15 años de experiencia.",
    ...
    },
    {
      ...
      "description": "Script doctoring, asesoría y redacción de guiones para cine, TV y publicidad. Servicio freelance de consultoría narrativa.",
      "provider": { "@id": "https://leosenderovsky.com.ar/#person" },
      "areaServed": { "@type": "Country", "name": "Argentina" },
    ...
    },
    {
      ...
      "description": "Charlas y ciclos de cine para instituciones educativas y grupos privados. Especialización en cine judío, cine argentino y cine en dictadura.",
      "provider": { "@id": "https://leosenderovsky.com.ar/#person" },
      "areaServed": { "@type": "Country", "name": "Argentina" },
    ...
    },
    {
      ...
      "description": "Desarrollo de sitios y aplicaciones web a medida. Frontend developer con React, HTML, CSS y JavaScript para proyectos personales y pymes.",
      "provider": { "@id": "https://leosenderovsky.com.ar/#person" },
      "areaServed": { "@type": "Country", "name": "Argentina" },
    ...
    },
    {
      ...
      "description": "Proyectos de inteligencia artificial aplicados al sector audiovisual y web. Automatización, herramientas IA para producción de contenido.",
      "provider": { "@id": "https://leosenderovsky.com.ar/#person" },
      "areaServed": { "@type": "Country", "name": "Argentina" },
...
export function SchemaCourse({ name, description, url }: { name: string; description: string; url: string }) {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Course",
    "name": name,
...
export function SchemaProfilePage() {
  const schema = {
    ...
    "description": "Curriculum Vitae completo de Leo Aquiba Senderovsky: editor de video, guionista y consultor de guión con más de 15 años de experiencia.",
    "inLanguage": ["es", "en"]
  };
