...
export function Web() {
  ...
  return (
    <>
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto mt-8 text-xl font-body leading-relaxed text-white/90">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#timeline-web" className="border border-white text-white px-8 py-3 rounded-full hover:bg-white hover:text-[#0D0B2E] transition-colors font-heading text-xl uppercase">
                Mirá mis proyectos
              </a>
      ...
      <section id="timeline-web" className="py-20 text-white" style={{ backgroundColor: '#0D0B2E' }}>
        <div className="container mx-auto px-4">
          <SectionHeader title="Mis proyectos" subtitle="Web" theme="dark" />
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {experienciaWeb.map(item => (
              <div key={item.id} className="bg-[#1B1440] rounded-3xl shadow-lg overflow-hidden border border-transparent hover:shadow-2xl transition-shadow group">
