    ...
    <>
      ...
      >
        <div
          ...
          style={{
            background: "linear-gradient(to right, #1B1440, #1A74C0, #19D3FF)",
          }}
        />
          ...
          <div className="flex flex-col lg:flex-row gap-10 items-start">
            ...
            >
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <a
                  href="#portfolio-ia"
                  className="inline-flex items-center gap-2 px-8 py-3 border border-white text-white hover:bg-white hover:text-[#1A74C0] transition-all rounded-full font-heading text-xl uppercase"
                  style={{
                    fontFamily: '"Yanone Kaffeesatz",sans-serif',
                    fontSize: "1.3em",
                    textTransform: "uppercase",
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent p-6 flex flex-col justify-end">
                  <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    <div className="font-heading text-white text-sm font-bold uppercase tracking-widest mb-2">
                      {item.category}
                    </div>
