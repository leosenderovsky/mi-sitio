  ...
  return (
    <>
      <PageSEO
        ...
        description="Leo Senderovsky: editor de video senior, guionista, consultor de guión y docente de cine en Buenos Aires. Desarrollo web y soluciones de IA (sender.ia)."
        path="/"
