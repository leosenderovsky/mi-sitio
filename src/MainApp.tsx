        ...
        <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
          ...
          <div className="flex flex-col min-h-screen bg-site-dark overflow-x-hidden">
            ...
            <main className="flex-grow pt-24">
              <Suspense
                fallback={
                  <div className="min-h-screen flex items-center justify-center bg-site-dark text-white">
                    Cargando...
                  </div>
                }
              >
                <Routes>
                  ...
                  <Route
                    path="/audiovisual/cv"
                    element={<Navigate to="/audiovisual/cv/castellano" replace />}
                  />
